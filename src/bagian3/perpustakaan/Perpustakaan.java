    ...
    public void cariPenulis(String penulis) {
        ...
        for (Buku b : koleksi) {
            ...
            if (b.getPenulis().equalsIgnoreCase(penulis)) {
                ...
                ditemukan = true; // Tandai bahwa minimal ada 1 buku ditemukan
            }
        }

        // Jika setelah keliling array ternyata tidak ada yang cocok
        if (!ditemukan) {
            System.out.println("Tidak ada koleksi buku dari penulis " + penulis);
        }
    }
}
